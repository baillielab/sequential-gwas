...
process MergeVCFsByChr {
    ...
    script:
        ...
        conda run -n bcftools_env bcftools merge --threads ${task.cpus} -o ${output} -O z -l merge_list.txt
        """
}
...
process IndexVCF {
    ...
    script:
        """
        conda run -n bcftools_env bcftools index --tbi --threads ${task.cpus} ${vcf_file}
        """
}
