...
workflow Report {
    ...
    main:
        ...
        basic_qc_reports = basic_qc_reports_all_releases.branch{ it ->
            release_r8: it[0] == "release-r8"
            release_20212023: it[0] == "release-2021-2023"
            release_2024_now: it[0] == "release-2024-now"
        }
        MakeReport(
            ...
            basic_qc_reports.release_r8,
            basic_qc_reports.release_20212023,
            basic_qc_reports.release_2024_now,
            kgp_qc_files_r8,
            kgp_qc_files_2021_2023,
            kgp_qc_files_2024_now,
            shared_variants,
